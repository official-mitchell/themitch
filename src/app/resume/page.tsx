...
import { ResumeTimelineSection } from "@/components/resume-timeline-section";
    ...
    <section className="min-h-screen bg-white text-black py-12 md:py-20 print:py-0">
      <div className="max-w-4xl mx-auto px-4 md:px-6 lg:px-8 print:px-6">
        ...
        <div className="text-black">
          ...
          {/* Profile Section */}
          <ResumeTimelineSection title="Profile">
          ...
          <ResumeTimelineSection title="Work Experience">
                ...
                >
                  ...
                  <ul className="space-y-2">
                    {job.description.map((point, pidx) => (
                      ...
                      >
                        <span className="text-amber-600 flex-shrink-0 mt-0.5 text-base">
                          •
                        </span>
                        <span>{point}</span>
                      </li>
          ...
          {/* Education Section */}
          <ResumeTimelineSection title="Education">
            <div className="space-y-6 print:space-y-4">
          ...
          {/* Skills Section */}
          <ResumeTimelineSection title="Skills">
          ...
          {/* Other Section */}
          <ResumeTimelineSection title="Other">
            <div className="space-y-4 print:space-y-3">
